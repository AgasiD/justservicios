...
using JustServicios.Clases;
    ...
    [System.Web.Http.RoutePrefix("api/Remito")]
public class RemitoController : ApiController
{
    ControladorRemito cRemitos = ControladorRemito.getInstancia();
    ControladorTotales   cTotales   = ControladorTotales.getCTotales();   

    [System.Web.Http.HttpPost]
    [System.Web.Http.Route("finalizarRemito")]
    public JsonResult<RequestHTTP> finalizarRemito(JObject cabydet)
    {
       
        return Json(cRemitos.finalizarRemito(cabydet));
