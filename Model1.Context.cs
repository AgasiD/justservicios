...
namespace JustServicios
{
    ...
    public partial class GestionEntities : DbContext
    {
        ...
        public virtual DbSet<configenML> configenML { get; set; }
        ...
        public virtual DbSet<notificacionesML> notificacionesML { get; set; }
        ...
        [DbFunction("GestionEntities", "LIvaCompra")]
        public virtual IQueryable<LIvaCompra_Result> LIvaCompra(Nullable<int> empresa)
        {
            var empresaParameter = empresa.HasValue ?
                new ObjectParameter("Empresa", empresa) :
                new ObjectParameter("Empresa", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<LIvaCompra_Result>("[GestionEntities].[LIvaCompra](@Empresa)", empresaParameter);
        }
        ...
        public virtual IQueryable<LStockActua_Result> LStockActua(Nullable<decimal> empresa)
        {
            var empresaParameter = empresa.HasValue ?
                new ObjectParameter("Empresa", empresa) :
                new ObjectParameter("Empresa", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<LStockActua_Result>("[GestionEntities].[LStockActua](@Empresa)", empresaParameter);
        }
        ...
        public virtual IQueryable<StockValorizado_Result> StockValorizado(Nullable<int> empresa)
        {
            var empresaParameter = empresa.HasValue ?
                new ObjectParameter("empresa", empresa) :
                new ObjectParameter("empresa", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<StockValorizado_Result>("[GestionEntities].[StockValorizado](@empresa)", empresaParameter);
        }
    
        [DbFunction("GestionEntities", "VclienteFechas")]
        public virtual IQueryable<VclienteFechas_Result> VclienteFechas(Nullable<System.DateTime> dsd, Nullable<System.DateTime> hst)
        {
            var dsdParameter = dsd.HasValue ?
                new ObjectParameter("dsd", dsd) :
                new ObjectParameter("dsd", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<VclienteFechas_Result>("[GestionEntities].[VclienteFechas](@dsd, @hst)", dsdParameter, hstParameter);
        }
        ...
        [DbFunction("GestionEntities", "WClienteImei")]
        public virtual IQueryable<WClienteImei_Result> WClienteImei(Nullable<int> imei, string dia, Nullable<int> empresa)
        {
            var imeiParameter = imei.HasValue ?
                new ObjectParameter("imei", imei) :
                new ObjectParameter("imei", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<WClienteImei_Result>("[GestionEntities].[WClienteImei](@imei, @dia, @empresa)", imeiParameter, diaParameter, empresaParameter);
        }
    
        [DbFunction("GestionEntities", "WPrecio")]
        public virtual IQueryable<WPrecio_Result> WPrecio(string producto, Nullable<int> cliente, Nullable<int> empresa)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<WPrecio_Result>("[GestionEntities].[WPrecio](@producto, @Cliente, @empresa)", productoParameter, clienteParameter, empresaParameter);
        }
        ...
        public virtual int sp_NoVendidos(Nullable<System.DateTime> desde, Nullable<System.DateTime> hasta, Nullable<int> empresa, Nullable<bool> incluirCoti)
        {
            var desdeParameter = desde.HasValue ?
                new ObjectParameter("desde", desde) :
                new ObjectParameter("desde", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_NoVendidos", desdeParameter, hastaParameter, empresaParameter, incluirCotiParameter);
        }
    
        public virtual int sp_PuntoPedido(Nullable<int> incluye, Nullable<int> empresa, Nullable<System.DateTime> dsd, Nullable<System.DateTime> hst)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_PuntoPedido", incluyeParameter, empresaParameter, dsdParameter, hstParameter);
        }
        ...
        public virtual int StockxArticulo(Nullable<decimal> empresa)
        {
            var empresaParameter = empresa.HasValue ?
                new ObjectParameter("empresa", empresa) :
                new ObjectParameter("empresa", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("StockxArticulo", empresaParameter);
        }
    }
}
